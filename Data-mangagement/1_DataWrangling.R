...
# choice of what to do with i dont know, not applicable
dim(B7_SWE)
dim(M7_SWE)
...
table(names(M7_SWE_rmItems) %in% derived_itemsEtimss)
table(names(B7_SWE_rmItems) %in% derived_itemsPtimss)
