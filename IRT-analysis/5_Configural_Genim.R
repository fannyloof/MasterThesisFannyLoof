...
## For list
dat[[1]]$S51115[dat[[1]]$mode_adm == "Ptimss"] <- NA
dat[[5]]$S51003[dat[[5]]$mode_adm == "Ptimss"] <- NA
dat[[5]]$S51035[dat[[5]]$mode_adm == "Ptimss"] <- NA
dat[[5]]$S51131B[dat[[5]]$mode_adm == "Ptimss"] <- NA
dat[[5]]$S51142[dat[[5]]$mode_adm == "Ptimss"] <- NA
dat[[6]]$S61083B[dat[[6]]$mode_adm == "Ptimss"] <- NA
dat[[7]]$S51194[dat[[7]]$mode_adm == "Ptimss"] <- NA
dat[[9]]$S61159[dat[[9]]$mode_adm == "Ptimss"] <- NA
dat[[11]]$S61161[dat[[11]]$mode_adm == "Ptimss"] <- NA
dat[[13]]$S61096[dat[[13]]$mode_adm == "Ptimss"] <- NA
dat[[13]]$S61113[dat[[13]]$mode_adm == "Ptimss"] <- NA
...
#### Configural and scalar
modeldat <- groups_notfull[["block_3"]][,!names(groups_notfull[["block_3"]]) %in% remove_cols]
...
#### Configural and scalar
modeldat <- groups_notfull[["block_5"]]

### Fit a configural model
configural <- multipleGroup(data = modeldat, 1, itemtype = "Rasch", group = as.factor(groups[["full_5"]]$group))
...
conscal11 <- rbind(con11 = fitcon11, scal11 = fitscal13)
...
# scalar_alldata     45059.1 45277.47 45216.80 45503.08 -22458.55              
# configural_alldata 45032.1 45831.78 45609.62 46657.94 -22256.05 404.995 189 0
...
# saveRDS(dat, file = "R-objects/Scored_blocks_Configural_Rasch.rds")
